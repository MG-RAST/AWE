// Modified based on Go Pkg file: container/heap/example_test.go
// Implement a priority queue data structure using the heap interface.
package pqueue
...
func NewItem(v string, p int64) *Item {
	return &Item{
		value:    v,
		priority: p,
	}
...
func (pq *PriorityQueue) update(value string, priority int64) {
...
func (pq *PriorityQueue) changePriority(item *Item, priority int64) {
